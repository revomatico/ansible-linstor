...
1. `apt-get update; apt-cache search '(linstor*|drbd-*)' | awk '{print $1}' | xargs apt-cache madison | grep linbit-drbd9-stack | grep amd64`:

   ```
    drbd-dkms | 9.1.3-1ppa1~focal1 | http://ppa.launchpad.net/linbit/linbit-drbd9-stack/ubuntu focal/main amd64 Packages
   drbd-module-source | 9.1.3-1ppa1~focal1 | http://ppa.launchpad.net/linbit/linbit-drbd9-stack/ubuntu focal/main amd64 Packages
   drbd-reactor | 0.4.3-1ppa1~focal1 | http://ppa.launchpad.net/linbit/linbit-drbd9-stack/ubuntu focal/main amd64 Packages
   drbd-utils | 9.18.2-1ppa1~focal1 | http://ppa.launchpad.net/linbit/linbit-drbd9-stack/ubuntu focal/main amd64 Packages
   drbd8-utils | 2:9.18.2-1ppa1~focal1 | http://ppa.launchpad.net/linbit/linbit-drbd9-stack/ubuntu focal/main amd64 Packages
   linstor-client | 1.9.0-1ppa1~focal1 | http://ppa.launchpad.net/linbit/linbit-drbd9-stack/ubuntu focal/main amd64 Packages
   linstor-common | 1.14.0-1ppa1~focal1 | http://ppa.launchpad.net/linbit/linbit-drbd9-stack/ubuntu focal/main amd64 Packages
   linstor-controller | 1.14.0-1ppa1~focal1 | http://ppa.launchpad.net/linbit/linbit-drbd9-stack/ubuntu focal/main amd64 Packages
   linstor-satellite | 1.14.0-1ppa1~focal1 | http://ppa.launchpad.net/linbit/linbit-drbd9-stack/ubuntu focal/main amd64 Packages
   python-linstor | 1.9.0-1ppa1~focal1 | http://ppa.launchpad.net/linbit/linbit-drbd9-stack/ubuntu focal/main amd64 Packages
   ```
...
2. In `playbook-vars.yml` add (while keeping all the required packages in the list):
   ...
   os_packages:
     ubuntu:
       common:
       - drbd-dkms=9.1.3-1ppa1~focal1
       - drbd-utils=9.18.2-1ppa1~focal1
       - linstor-client=1.9.0-1ppa1~focal1
       controller:
       - linstor-controller=1.14.0-1ppa1~focal1
       satellite:
       - linstor-satellite=1.14.0-1ppa1~focal1
   ```
